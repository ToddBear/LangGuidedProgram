...
class LayerNormGRUCell(RNNCellBase):
    ...
    def forward(self, input, hx):
        ...
        # use layernorm here
        resetgate = torch.sigmoid(self.ln_resetgate(i_r + h_r))
        inputgate = torch.sigmoid(self.ln_inputgate(i_i + h_i))
        newgate = torch.tanh(self.ln_newgate(i_n + resetgate * h_n))
